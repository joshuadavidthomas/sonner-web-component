...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/index.js"></script>
```
...
```html
<script type="module">
  import { toast } from "https://cdn.jsdelivr.net/npm/sonner-web-component/dist/index.js"
  toast("Hello!")
</script>
```
...
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/index.js"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/bridges/htmx.js"></script>
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/index.js"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/bridges/fetch.js"></script>
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/index.js"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/sonner-web-component/dist/bridges/alpine.js"></script>
